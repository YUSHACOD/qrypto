...
impl KemAlgorithms {
    ...
    pub fn to_string(&self) -> String {
        match *self {
            ...
            Self::ClassicMcEliece348864 => "classic_mc_eliece348864".to_string(),
            Self::ClassicMcEliece348864f => "classic_mc_eliece348864f".to_string(),
            Self::ClassicMcEliece460896 => "classic_mc_eliece460896".to_string(),
            Self::ClassicMcEliece460896f => "classic_mc_eliece460896f".to_string(),
            Self::ClassicMcEliece6688128 => "classic_mc_eliece6688128".to_string(),
            Self::ClassicMcEliece6688128f => "classic_mc_eliece6688128f".to_string(),
            Self::ClassicMcEliece6960119 => "classic_mc_eliece6960119".to_string(),
            Self::ClassicMcEliece6960119f => "classic_mc_eliece6960119f".to_string(),
            Self::ClassicMcEliece8192128 => "classic_mc_eliece8192128".to_string(),
            Self::ClassicMcEliece8192128f => "classic_mc_eliece8192128f".to_string(),
            Self::Hqc128 => "hqc128".to_string(),
            Self::Hqc192 => "hqc192".to_string(),
            Self::Hqc256 => "hqc256".to_string(),
            Self::Kyber512 => "kyber512".to_string(),
            Self::Kyber768 => "kyber768".to_string(),
            Self::Kyber1024 => "kyber1024".to_string(),
            Self::NtruPrimeSntrup761 => "ntru_prime_sntrup761".to_string(),
            Self::FrodoKem640Aes => "frodo_kem640_aes".to_string(),
            Self::FrodoKem640Shake => "frodo_kem640_shake".to_string(),
            Self::FrodoKem976Aes => "frodo_kem976_aes".to_string(),
            Self::FrodoKem976Shake => "frodo_kem976_shake".to_string(),
            Self::FrodoKem1344Aes => "frodo_kem1344_aes".to_string(),
            Self::FrodoKem1344Shake => "frodo_kem1344_shake".to_string(),
        }
    }
}
...
impl SigAlgorithms {
    ...
    pub fn to_string(&self) -> String {
        match *self {
            Self::Dilithium2 => "dilithium2".to_string(),
            Self::Dilithium3 => "dilithium3".to_string(),
            Self::Dilithium5 => "dilithium5".to_string(),
            Self::Falcon512 => "falcon512".to_string(),
            Self::Falcon1024 => "falcon1024".to_string(),
            Self::SphincsSha2128fSimple => "sphincs_sha2128f_simple".to_string(),
            Self::SphincsSha2128sSimple => "sphincs_sha2128s_simple".to_string(),
            Self::SphincsSha2192fSimple => "sphincs_sha2192f_simple".to_string(),
            Self::SphincsSha2192sSimple => "sphincs_sha2192s_simple".to_string(),
            Self::SphincsSha2256fSimple => "sphincs_sha2256f_simple".to_string(),
            Self::SphincsSha2256sSimple => "sphincs_sha2256s_simple".to_string(),
            Self::SphincsShake128fSimple => "sphincs_shake128f_simple".to_string(),
            Self::SphincsShake128sSimple => "sphincs_shake128s_simple".to_string(),
            Self::SphincsShake192fSimple => "sphincs_shake192f_simple".to_string(),
            Self::SphincsShake192sSimple => "sphincs_shake192s_simple".to_string(),
            Self::SphincsShake256fSimple => "sphincs_shake256f_simple".to_string(),
            Self::SphincsShake256sSimple => "sphincs_shake256s_simple".to_string(),
        }
    }
}
